...
=======
        <h4>Students</h4></div>
>>>>>>> 563f448cbb3e89a64601fff61b5d36079e36dbce
</div>
...
=======
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12"><p><a href="<?php echo base_url('super/parents');?>" class="btn btn-danger btn-xs"><i class="fa fa-eye"></i> All Students List</a></p></div>
                  <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                      <div class="panel panel-yellow">
                          <div class="panel-body">
